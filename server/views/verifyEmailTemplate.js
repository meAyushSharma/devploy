module.exports.verifyEmailTemplate = code => `<!DOCTYPE html>
<html lang="en-US">
<head>
    <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
    <title>Verify registration email</title>
                                ...
                                <tr>
                                    <td style="padding: 0 35px;">
                                        <h1 style="color: #1e1e2d; font-weight: 500; margin: 0; font-size: 32px; font-family: 'Satoshi', sans-serif;">
                                            You have requested to register at devploynest.in
                                        </h1>
                                        ...
                                        <p style="color: #455056; font-size: 15px; line-height: 24px; margin: 0;">
                                            A unique code to verify your email has been generated for you. 
                                            To verify your email, paste the following code in signup window and follow the instructions.
                                        </p>
                                        <div
