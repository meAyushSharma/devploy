...
const SubGate = memo(({heading, subValue, setSub, gateValue, setGate, label, onClickFun}) => {
    return <div className="">
                    <span className="font-medium text-gray-800 md:text-lg sm:text-base text-sm">{heading}</span>
                    <div className="grid md:grid-cols-5 text-center my-2">
                        ...
                        <div className="w-full">
                            <div className="w-fit m-auto my-1">
